...
// App Colors - matching your HomeScreen
class AppColors {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // FLOATING CLASS PANEL (Left)
          if (_showClassPanel) _buildClassPanel(),
          
          // FLOATING CONSOLE (Bottom)
          if (_showConsole) _buildConsole(),
          
          // FLOATING RESULTS (Right) - Inference Mode
            ...
            child: Row(
              ...
              children: [
                Icon(
                  ...
                  color: _modelLoaded ? AppColors.success : AppColors.error,
                  size: 16,
                ),
    ...
    return Positioned(
      ...
      child: Column(
        children: [
          // Class Panel Toggle
          _buildActionButton(
            icon: _showClassPanel ? Icons.close : Icons.dashboard,
            color: AppColors.primary,
            onTap: () {
              setState(() {
                _showClassPanel = !_showClassPanel;
                if (_showClassPanel) {
                  _classPanelController.forward();
                } else {
                  _classPanelController.reverse();
                }
              });
            },
          ),
          ...
          if (_isTrainingMode) ...[
            ...
            const SizedBox(height: 12),
            _buildActionButton(
              icon: _isTraining ? Icons.hourglass_empty : Icons.play_arrow,
              color: _isTraining ? AppColors.warning : AppColors.primaryDark,
          ...
          // Console Toggle
          _buildActionButton(
            icon: _showConsole ? Icons.keyboard_arrow_down : Icons.terminal,
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: isSelected ? Colors.white.withOpacity(0.3) : AppColors.accent.withOpacity(0.3),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      height: 24,
                      decoration: BoxDecoration(
                        color: isTop ? AppColors.primary : AppColors.accent.withOpacity(0.3),
                        shape: BoxShape.circle,
                      ),
                      child: Center(
                        child: Text(
                          '${i + 1}',
                          style: TextStyle(
                            color: isTop ? Colors.white : AppColors.textPrimary,
                            fontWeight: FontWeight.bold,
                            fontSize: 11,
                          ),
                        ),
